import ClientPhysiotherapist from "./ClientPhysiotherapist";
import { GetDrugServicesMeta } from "@/services/metatags/drugservicesMeta";

export async function generateMetadata() {
  const url = "physiotherapist";
  try {
    const post = await GetDrugServicesMeta(url);
    return {
      title:
        post.metatitle ||
...
const Physiotherapist = async () => {
  return (
    <>
      <ClientPhysiotherapist />
    </>
  );
};
