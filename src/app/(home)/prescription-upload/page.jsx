import ClientPrescriptionUpload from "./ClientPrescriptionUpload";
import { GetCommonMeta } from "@/services/metatags/commonMeta";

export async function generateMetadata() {
  const url = "prescription-upload";
  try {
    const post = await GetCommonMeta(url);
    return {
      title:
        post.metatitle ||
...
const PrescriptionUpload = async () => {
  return (
    <>
      <ClientPrescriptionUpload />
    </>
  );
};
