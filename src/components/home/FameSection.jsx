        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 mb-10 gap-2">
          {productList &&
            productList?.products?.map((product, i) => (
              <article
                className="relative mt-10 bg-white p-4 border rounded-lg shadow-md"
                key={i}
              >
                <div className="absolute top-2 left-1 text-white text-xs px-2 py-1 rounded-full">
                  <svg
                ...
                <div className="flex justify-center mb-4 mt-7">
                  <Image
                    src={WheatgrassJuice}
                    alt={`${product.product_name} - ${product.cat_name}`}
                ...
                <div>
                  ...
                  <h3 className="text-md font-bold text-gray-800 mb-0">
                    &#8377; {product?.price}
                  </h3>
